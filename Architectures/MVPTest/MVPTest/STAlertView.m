...
- (instancetype)initWithTitle:(nullable NSString *)title message:(nullable NSString *)message delegate:(nullable id <STAlertViewDelegate>)delegate cancelButtonTitle:(nullable NSString *)cancelButtonTitle otherButtonTitles:(nullable NSString *)otherButtonTitles, ... NS_REQUIRES_NIL_TERMINATION {
    ...
    NSMutableArray *tempOtherButtonTitles = [NSMutableArray arrayWithCapacity:2];
    if (otherButtonTitles)
    {
        [tempOtherButtonTitles addObject:otherButtonTitles];
    ...
    return [self initWithTitleByPrivate:title message:message delegate:delegate cancelButtonTitle:cancelButtonTitle otherButtonTitles:tempOtherButtonTitles];
}




+ (void)showAlertViewOnClickButtonBlock:(void (^)(STAlertView * _Nonnull, NSUInteger))block showType:(STAlertAnimationOptions)animationOption title:(NSString *)title message:(NSString *)message cancelButtonTitle:(NSString *)cancelButtonTitle otherButtonTitle:(NSString *)otherButtonTitles, ...NS_REQUIRES_NIL_TERMINATION{
    ...
    STAlertView *alertView = [[STAlertView alloc] initWithTitleByPrivate:title message:message delegate:nil cancelButtonTitle:cancelButtonTitle otherButtonTitles:tempOtherButtonTitles];
    alertView.clickButtonBlock = block;
    alertView.animationOption = animationOption;
    [alertView show];
}
...
+ (void)showAlertViewOnClickButtonBlock:(void (^)(STAlertView *alertView, NSUInteger buttonIndex))block showType:(STAlertAnimationOptions)animationOption viewCornerRaius:(CGFloat)radius title:(nullable NSString *)title message:(nullable NSString *)message cancelButtonTitle:(nullable NSString *)cancelButtonTitle  otherButtonTitle:(nullable NSString *)otherButtonTitles, ... NS_REQUIRES_NIL_TERMINATION{
    ...
    STAlertView *alertView = [[STAlertView alloc] initWithTitleByPrivate:title message:message delegate:nil cancelButtonTitle:cancelButtonTitle otherButtonTitles:tempOtherButtonTitles];
    alertView.clickButtonBlock = block;
    alertView.contentView.layer.cornerRadius = radius;
    alertView.animationOption = animationOption;
    [alertView show];
}
...
- (instancetype)initWithTitleByPrivate:(nullable NSString *)title message:(nullable NSString *)message delegate:(nullable id <STAlertViewDelegate>)delegate cancelButtonTitle:(nullable NSString *)cancelButtonTitle otherButtonTitles:(nullable NSArray *)otherButtonTitles
{
    self = [super init];
    if (self) {
...
- (UIView *)contentView{
    if (!_contentView) {
        ...
        [_contentView.layer setCornerRadius:0];
